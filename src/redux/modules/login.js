...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case types.LOGOUT: 
      return {...state, isFetching: false, status: false, username: '', password: ''}
    case types.SET_USERNAME:
      return {...state, isFetching: false, username: action.username}
    case types.SET_PASSWORD:
      return {...state, isFetching: false, password: action.password}
    default:
      return state;
  }
}
